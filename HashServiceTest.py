...
class HashServiceTest(unittest.TestCase):
    ...
    def test_uniswap_weth_dai_pair_address(self):
        ...
        tokenA = Web3.toChecksumAddress('0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2')

        # DAI -> https://etherscan.io/address/0x6B175474E89094C44Da98b954EedeAC495271d0F
        tokenB = Web3.toChecksumAddress('0x6B175474E89094C44Da98b954EedeAC495271d0F')

        # (WETH, DAI) -> https://etherscan.io/address/0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11
        expected_pair_address = Web3.toChecksumAddress('0xA478c2975Ab1Ea89e8196811F51A7B7Ade33eB11')
    ...
    def test_uniswap_weth_wbtc_pair_address(self):
        ...
        tokenB = Web3.toChecksumAddress('0x2260FAC5E5542a773Aa44fBCfeDf7C193bc2C599')

        # (WETH, WBTC) -> https://etherscan.io/address/0xBb2b8038a1640196FbE3e38816F3e67Cba72D940
        expected_pair_address = Web3.toChecksumAddress('0xBb2b8038a1640196FbE3e38816F3e67Cba72D940')
    ...
    def test_uniswap_usdc_occ_pair_address(self):
        ...
        tokenA = Web3.toChecksumAddress('0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48')

        # OCC -> https://etherscan.io/address/0x2F109021aFe75B949429fe30523Ee7C0D5B27207
        tokenB = Web3.toChecksumAddress('0x2F109021aFe75B949429fe30523Ee7C0D5B27207')

        # (USDC, OCC) -> https://etherscan.io/address/0xEdF1fA564a91a5664f172470C47450af17724757
        expected_pair_address = Web3.toChecksumAddress('0xEdF1fA564a91a5664f172470C47450af17724757')
    ...
    def test_pancake_swap_wbnb_laika_pair_address(self):
        ...
        tokenA = Web3.toChecksumAddress('0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c')

        # LAIKA -> https://bscscan.com/address/0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c
        tokenB = Web3.toChecksumAddress('0x270877FBDAdd2E28C7EAf08e528691B95684207e')

        # (WBNB, LAIKA) -> https://bscscan.com/address/0x90070E7a97fF3d52E5C6CaC49123562d266921B9
        expected_pair_address = Web3.toChecksumAddress('0x90070E7a97fF3d52E5C6CaC49123562d266921B9')
    ...
    def test_pancake_swap_wbnb_autocoin_pair_address(self):
        ...
        tokenB = Web3.toChecksumAddress('0x47b80b600d5e4d2a6c2e1bda0e2d460ef6689850')

        # (WBNB, AutoCoin) -> https://bscscan.com/address/0xd69ef9bf1e6ace24b2968acd42d2cf50504af800
        expected_pair_address = Web3.toChecksumAddress('0xd69ef9bf1e6ace24b2968acd42d2cf50504af800')
    ...
    def test_pancake_swap_wbnb_safemoon_pair_address(self):
        ...
        tokenB = Web3.toChecksumAddress('0x8076c74c5e3f5852037f31ff0093eeb8c8add8d3')  # SafeMoon

        # (WBNB, SafeMoon) -> https://bscscan.com/address/0x9adc6Fb78CEFA07E13E9294F150C1E8C1Dd566c0
        expected_pair_address = Web3.toChecksumAddress('0x9adc6Fb78CEFA07E13E9294F150C1E8C1Dd566c0')
